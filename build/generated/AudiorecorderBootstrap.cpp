...
#define TAG "in.shivakumars.audiorecorder"
...
Java_in_shivakumars_audiorecorder_AudiorecorderBootstrap_nativeBootstrap
	(JNIEnv *env, jobject self)
{
	titanium::KrollBindings::addExternalBinding("in.shivakumars.audiorecorder", &AudiorecorderBinding);
